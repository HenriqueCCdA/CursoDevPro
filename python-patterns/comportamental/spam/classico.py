...
class SpamAbstrata(ABC):
    ...
    def obter_contatos(self):
        """
        Deve retornar uma lista onde ada elemento é uma tupla. O primeiro
        elemento da tupla é o nome do contato e o segundo o seu endereço
        no respectivo canal de envio de mensagem
        """

    @abstractmethod
    def enviar_mensagem(self, nome, endereco, msg):
        """
        Deve enviar mensagem para usuário

        :param nome: str com nome do usuário
        :param endereco: str com endereço do usuário no canal
        :param mdg: str mensagem a ser enviada
...
if __name__ == '__main__':
    class SpamParaConsole(SpamAbstrata):
        def obter_contatos(self):
            return [('Renzo', 'renzo@email.com'), ('Matheus', 'matheus@email.com')]
